...
class Movie {
  ...
  int id;
  String
      originalLanguage; // Ahora será de tipo String: OriginalLanguage originalLanguage;
  ...
  get getPosterMovie {
    ...
    ///? Método get creado para obtener el poster de la película
  ...
  factory Movie.fromMap(Map<String, dynamic> json) => Movie(
        ...
        ///! Aquí intenta manejar el originalLanguageValues.map[json["original_language"]], basado en una enumeración. Se maneja mejor como un string
        originalTitle: json["original_title"],
        overview: json["overview"],
        popularity: json["popularity"].toDouble(),
        posterPath: json["poster_path"],
        releaseDate: json[
            "release_date"], // Como dijimos, se maneja como un string: DateTime.parse(json["release_date"]),
        title: json["title"],
        video: json["video"],
